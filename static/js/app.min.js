var app = {
    ...
    themePanel: {
        ...
        themeDirection: {
            toggleAttr: 'data-toggle="theme-direction-selector"',
            valueAttr: "data-theme-direction",
            cookieName: "app-theme-direction",
            activeClass: "active",
            attr: "dir"
        }
    },
  ...
  , handleThemePanel = function() {
    ...
    [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeDirection.toggleAttr + "]")).map(function(e) {
        e.onclick = function(e) {
            e.preventDefault();
            var t = this
              , e = t.getAttribute(app.themePanel.themeDirection.valueAttr) ? t.getAttribute(app.themePanel.themeDirection.valueAttr) : "";
            "rtl" == e ? document.querySelector("html").setAttribute(app.themePanel.themeDirection.attr, e) : document.querySelector("html").removeAttribute(app.themePanel.themeDirection.attr),
            Cookies && Cookies.set(app.themePanel.themeDirection.cookieName, e),
            t.classList.add(app.themePanel.themeDirection.activeClass),
            [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeDirection.toggleAttr + "]")).map(function(e) {
                e != t && e.classList.remove(app.themePanel.themeDirection.activeClass)
            }),
            handleCssVariable(),
            document.dispatchEvent(new CustomEvent("theme-reload"))
        }
    }),
    Cookies && Cookies.get(app.themePanel.themeDirection.cookieName) && (t = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeDirection.toggleAttr + "][" + app.themePanel.themeDirection.valueAttr + '="' + Cookies.get(app.themePanel.themeDirection.cookieName) + '"]')) && t.click()
}
  ...
  , App = {
    init: function() {
        ...
        this.initTopNav(),
        this.initAppLoad(),
        (e = jQuery) && e.fn && !e.fn.andSelf && e.fn.addBack && (e.fn.andSelf = e.fn.addBack),
        e && !e.isArray && (e.isArray = Array.isArray)
    },
